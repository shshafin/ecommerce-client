...
export function NewsletterSubscriber() {
  ...
  return (
    <div className="max-w-3xl mx-auto my-16">
      <div className="bg-white px-10 py-5 shadow-sm">
        <form
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="h-12 px-4 md:px-10 bg-[#FF004F] hover:bg-[#ff0033] cursor-pointer text-md text-white font-medium rounded-r-full rounded-l-none border-0 transition-colors">
